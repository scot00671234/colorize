    ...
    <div className="contentPage">
      <div className="contentCard">
        ...
        <div className="contentBody">
          <p>
            By using Wish Wello (this service), you agree to these terms. Please read them carefully.
          </p>
          <h2>Acceptance</h2>
          <p>
          ...
          <p>
            Wish Wello provides AI-powered photo colorization and restoration. You agree to use the service only for lawful purposes and in accordance with these terms. You are responsible for keeping your account credentials secure and for all activity under your account. Do not upload content you do not have the right to use.
          </p>
